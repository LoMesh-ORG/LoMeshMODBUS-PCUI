...
#  Aug 26, 2020 11:36:20 PM EDT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top42 {base} {
    ...
    wm geometry $top 694x450+562+153
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    ttk::notebook $top.tNo43 \
        -width 351 -height 396 -takefocus {} 
    ...
    ttk::combobox $site_4_0.tCo44 \
        -font TkTextFont -justify center -textvariable combobox_sf \
        -foreground {} -background {} -takefocus {} 
    vTcl:DefineAlias "$site_4_0.tCo44" "Combobox_sf" vTcl:WidgetProc "Toplevel1" 1
    ...
    place $site_4_0.lab67 \
        -in $site_4_0 -x 0 -relx 0.031 -y 0 -rely 0.351 -width 0 \
        -relwidth 0.302 -height 0 -relheight 0.057 -anchor nw \
        -bordermode ignore 
    ...
    place $site_4_0.lab73 \
        -in $site_4_0 -x 0 -relx 0.031 -y 0 -rely 0.595 -width 0 \
        -relwidth 0.29 -height 0 -relheight 0.057 -anchor nw \
        -bordermode ignore 
    ...
    place $site_4_0.tCo44 \
        -in $site_4_0 -x 0 -relx 0.37 -y 0 -rely 0.351 -width 0 \
        -relwidth 0.503 -height 0 -relheight 0.057 -anchor nw \
        -bordermode ignore 
    frame $top.tNo43.t1 \
        -background $vTcl(actual_gui_bg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
    ...
    place $site_4_2.lab48 \
        -in $site_4_2 -x 0 -relx 0.031 -y 0 -rely 0.162 -width 0 \
        -relwidth 0.198 -height 0 -relheight 0.057 -anchor nw \
        -bordermode ignore 
    ...
    place $site_4_2.but53 \
        -in $site_4_2 -x 0 -relx 0.37 -y 0 -rely 0.514 -width 67 -relwidth 0 \
        -height 44 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_2.but54 \
        -in $site_4_2 -x 0 -relx 0.71 -y 0 -rely 0.514 -width 67 -relwidth 0 \
        -height 44 -relheight 0 -anchor nw -bordermode ignore 
    place $site_4_2.but55 \
        -in $site_4_2 -x 10 -y 260 -width 67 -height 44 -anchor nw \
        -bordermode ignore 
    place $site_4_2.but56 \
        -in $site_4_2 -x 0 -relx 0.37 -y 0 -rely 0.703 -width 67 -height 44 \
        -anchor nw -bordermode ignore 
    place $site_4_2.but49 \
        -in $site_4_2 -x 0 -relx 0.71 -y 0 -rely 0.703 -width 67 -relwidth 0 \
        -height 44 -relheight 0 -anchor nw -bordermode ignore 
    frame $top.tNo43.t3 \
        -background $vTcl(actual_gui_bg) \
        -highlightbackground $vTcl(actual_gui_bg) -highlightcolor black 
